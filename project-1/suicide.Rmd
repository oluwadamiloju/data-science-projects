...
Null hypothesis (h_0): There is no relationship between age and generation  
...
One-way ANOVA tests between The suicide percentage and age, and the suicide percentage and sex 

Null hypothesis (h_0): There is no difference between the group means of the independent and residual variables  
Alternative hypothesis (h_a): The is a difference in group means
...
The p-value of the age variable is low (p < 0.001), so it appears that the age groups have a high significance on the suicide percentage of United States of America.  
...
The p-value of the sex variable is low (p < 0.001), so it appears that the sexes have a high significance on the suicide percentage of United States of America.  
