...
chisq.test(us_df$generation, us_df$age, correct=FALSE)

# We have a chi-squared value of 588.2. Since we get a p-Value less than 
# the significance level of 0.05 (2.2e-16), we reject the null hypothesis and conclude 
